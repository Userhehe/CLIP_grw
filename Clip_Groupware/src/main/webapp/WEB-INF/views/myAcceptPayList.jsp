...
<body>
	...
	<div class="card">
		<div class="card-body">
			...
			<div >
				<h4 class="card-title"><span class="card-title" style="color: skyblue;">${loginVo.user_name}</span> 의 승인 대기중인 결재 리스트</h4>
              ...
              <div class="datatable-wrapper datatable-loading no-footer sortable searchable fixed-columns col-sm-12"><div class="datatable-top">
				    ...
				    <div class="col-sm-3">
	                  	미확인 결재만 조회<input type="checkbox" value="noCheck">
	               	 </div>
				    <div class="col-sm-1">
            		...
            		<div class="modal-content">
	                    ...
	                    <div class="modal-footer">
	                     <a href="#">PDF 저장<img alt="PDF.img" src="./images/pdfImg.png"></a>
	                      <button type="button" class="btn btn-warning" data-bs-dismiss="modal">결재 승인</button>
	                      <button type="button" class="btn btn-secondary">결재 반려</button>
