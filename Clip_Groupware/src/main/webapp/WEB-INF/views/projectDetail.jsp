			...
			<div class="row" style="width: 50%; flex-wrap: nowrap;">
				<div class="col-md-1"
					...
					<div class="title">
							...
							<div style="margin-top: 10px; font-size: large; font-weight: 300;">현장주소
				...
				<div style="display: flex; justify-content: flex-end;">
					<div style="width: calc(550px - 50px); margin-bottom: 20px; margin-top: 5px; margin-right: 20px;">
						<!-- 수정 -->
						<div class="progress mt-3" style="width: calc(100% + 50px - 50px); margin-bottom: 25px;">
							<!-- 수정 -->
...
<div>
    <textarea class="form-control" style="height: 250px; margin-top: 5px; text-align: center;" placeholder="내용을 입력하세요"></textarea>
</div>

					<div class="d-grid gap-2 mt-3">
						<button class="btn btn-warning" type="button">등록</button>
					</div>
					<div>
